export default function Productbox({ prodDestacado }) {
  return (
    <div className="h-[363px] md:h-[444px] w-60 md:w-80 mx-2 rounded-2xl flex-shrink-0 bg-[--clr-rojo]">
      <div className="rounded-t-2xl overflow-hidden h-auto relative">
        <img
          className="rounded-t-2xl"
          src={`/src/assets/images/${prodDestacado.id}.webp`}
          alt={prodDestacado.nombre}
        />
      ...
      <div className="px-2 md:px-3 py-2 flex flex-col gap-1.5 text-sm">
        <h2 className="text-sm font-bold whitespace-normal text-white line-clamp-2">
          {prodDestacado.nombre}
        </h2>
        <p className="text-white text-sm">
          {prodDestacado.codigo}
        </p>
