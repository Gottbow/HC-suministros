...
const Us = () => {
  return (
    <div className="App bg-[#101010]">
      ...
      <div class="grid justify-items-center text-center sm:mt-40 sm:m-36 sm:grid-cols-3 sm:gap-52 grid-cols-2 m-10 gap-10 place-content-evenly h-full max-h-screen text-white">
        <div>
          <p class="md:text-xl text-[14px]">Lorem</p>
          <p class="sm:text-7xl text-2xl hover:text-[#AB4D4D] text">
            Lorem rem facere
          </p>
        </div>
        <div>
            ...
            <ul class="list-none mt-6">
              <li class="py-2">
                <div class="flex items-center">
                  <div></div>
                  <div>
                    <h4 class="text-[#AB4D4D] font-semibold text-3xl">
                      Lorem Ipsum
                    </h4>
                    <p class="mt-4 text-lg leading-relaxed text-[#DCDCDC]">
      ...
      <div class="flex items-center w-screen bg-[#101010] mt-12">
        <div class="container mx-auto my-3 px-4 lg:px-20">
          <div class="w-full p-8 my-4 md:px-16 mr-auto bg-white rounded-2xl">
            <div class="flex">
              <h1 class="font-bold uppercase text-5xl">Contacto</h1>
            </div>
